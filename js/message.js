$(document).ready(function(){
  ...
  $('body').on('click','#buyNow',function(){
    $("#send-whatsapp").attr("href", "https://bit.ly/2kb4Aw3");
    $("#myModal").show();
  });
...
function createUriEncoding(){
  ...
  var messageLink = "https://api.whatsapp.com/send?phone=918220938999&text=%5F%2AHi%E2%80%9A%2A%5F%0A%5F%2AThis%20is%20a%20voice%20of%20a%20Customer%2A%5F%0A%0A%2AName%2A%20%3A" + name + "%0A%0A%2AEmail%2A%20%3A" + email + "%0A%0A%2AComments%2A%20%3A" + comments;
...
function modalReset(){
  ...
  $("#send-whatsapp").attr("href", "https://bit.ly/2Gz7C5M");
  $("#modal-call").show();
  $("#modal-message").show();
